...
print_welcome() {
    ...
    echo "${BG_BLUE}${BOLD}       Welcome to Cloud Hustlers Tutorials!     ${RESET}"
...
print_completion() {
    ...
    echo "${CYAN}${BOLD}https://www.youtube.com/@CloudHustlers/videos${RESET}"
    echo
}
...
module "vpc" {
    ...
    subnets = [
        ...
        },
        {
            ...
            description           = "Subscribe to Cloud Hustlers"
        },
    ]
}
EOF_CP
