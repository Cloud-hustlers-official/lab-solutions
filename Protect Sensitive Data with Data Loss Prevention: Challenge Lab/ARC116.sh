...
echo "${CYAN_TEXT}${BOLD_TEXT}     WELCOME TO CLOUD HUSTLERS TUTORIALS - SUBSCRIBE THE CHANNEL.  ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}Don't forget to Like, Share and Subscribe to Cloud Hustlers channel${RESET_FORMAT}"
echo
