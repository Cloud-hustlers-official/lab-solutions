...
echo "${PURPLE_TEXT}${BOLD_TEXT}    WELCOME TO CLOUD HUSTLERS TUTORIALS   ${RESET_FORMAT}"
echo "${PURPLE_TEXT}${BOLD_TEXT}=============================================${RESET_FORMAT}"
echo ""
...
echo "${LIME_TEXT}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo ""
echo -e "${MAROON_TEXT}${BOLD_TEXT}Subscribe to Cloud Hustlers Channel:${RESET_FORMAT} ${NAVY_TEXT}${BOLD_TEXT}https://www.youtube.com/@CloudHustlers${RESET_FORMAT}"
echo
