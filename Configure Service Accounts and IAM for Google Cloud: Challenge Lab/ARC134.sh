...
echo "${CYAN_TEXT}${BOLD_TEXT}🚀  Cloud Hustlers Tutorials - Lab  🚀${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=========================================${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}=========================================${RESET_FORMAT}"
echo
echo "${BLUE_TEXT}${BOLD_TEXT}Thank you for using Cloud Hustlers Tutorials!${RESET_FORMAT}"
echo
echo "${YELLOW_TEXT}${BOLD_TEXT}For more cloud tutorials and labs, visit:${RESET_FORMAT}"
echo "${CYAN_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@CloudHustlers/videos${RESET_FORMAT}"
echo
