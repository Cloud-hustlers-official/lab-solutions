...
echo "${ORANGE_TEXT}${BOLD_TEXT}           WELCOME TO CLOUD HUSTLERS GUIDE${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}                 PARTY DO SAB..${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo

echo "${ORANGE_TEXT}${BOLD_TEXT}Getting Lab Credentials...${RESET_FORMAT}"
