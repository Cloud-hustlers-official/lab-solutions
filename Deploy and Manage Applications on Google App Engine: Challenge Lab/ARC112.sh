...
echo "${PURPLE_COLOR}${BOLD_TEXT}  WELCOME TO CLOUD HUSTLERS TUTORIALS  ${RESET_FORMAT}"
echo "${PURPLE_COLOR}${BOLD_TEXT}=============================================${RESET_FORMAT}"
echo
...
echo "${MAROON_COLOR}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo
echo -e "${NAVY_COLOR}${BOLD_TEXT}Check out Cloud Hustlers Channel: \e]8;;https://www.youtube.com/@CloudHustlers\e\\https://www.youtube.com/@CloudHustlers\e]8;;\e\\${RESET_FORMAT}"
echoF
