...
echo "${CYAN}${BOLD}║                   🎉 WELCOME TO CLOUD HUSTLERS! 🎉           ║${RESET}"
echo "${CYAN}${BOLD}║                                                              ║${RESET}"
echo "${CYAN}${BOLD}║          Thank you for using this Apigee setup script!      ║${RESET}"
echo "${CYAN}${BOLD}║                                                              ║${RESET}"
echo "${CYAN}${BOLD}║     📺 YouTube: https://www.youtube.com/@CloudHustlers    ║${RESET}"
echo "${CYAN}${BOLD}║                                                              ║${RESET}"
...
echo "${CYAN}${BOLD}   https://www.youtube.com/@CloudHustlers${RESET}"
echo ""
