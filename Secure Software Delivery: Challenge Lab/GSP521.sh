...
echo "${BG_MAGENTA}${BOLD}         WELCOME TO CLOUD HUSTLERS TUTORIAL              ${RESET}"
echo "${BG_MAGENTA}${BOLD}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${CYAN}${BOLD}          Expert Tutorial by Cloud Hustlers           ${RESET}"
echo "${YELLOW}For more GCP security tutorials, visit: https://www.youtube.com/@CloudHustlers${RESET}"
echo
...
echo "${BG_GREEN}${BOLD}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${RED}${BOLD}🙏 Thank you for following Cloud Hustlers tutorial!${RESET}"
echo "${YELLOW}${BOLD}📺 Subscribe for more GCP security content:${RESET}"
echo "${BLUE}https://www.youtube.com/@CloudHustlers${RESET}"
echo
