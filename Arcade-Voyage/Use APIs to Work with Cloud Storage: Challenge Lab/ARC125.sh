...
echo "${HEADER_COLOR}${BOLD}║    WELCOME TO CLOUD HUSTLER JOURNEY    ║${RESET}"
echo "${HEADER_COLOR}${BOLD}╚════════════════════════════════════════╝${RESET}"
echo
...
curl -s -LO https://github.com/Cloud-hustlers-official/lab-solutions/blob/main/Arcade-Voyage/Use%20APIs%20to%20Work%20with%20Cloud%20Storage%3A%20Challenge%20Lab/world.jpeg
