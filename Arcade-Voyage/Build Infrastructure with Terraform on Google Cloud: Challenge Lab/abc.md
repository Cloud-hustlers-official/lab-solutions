...
```
curl -LO https://raw.githubusercontent.com/Cloud-hustlers-official/lab-solutions/refs/heads/main/Arcade-Voyage/Build%20Infrastructure%20with%20Terraform%20on%20Google%20Cloud%3A%20Challenge%20Lab/abc.sh
sudo chmod +x abc.sh
./abc.sh
```
### Congratulations !!!!
