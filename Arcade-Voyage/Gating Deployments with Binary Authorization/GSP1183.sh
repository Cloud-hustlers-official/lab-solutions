...
echo "#######################################################################"
echo "#                                                                     #"
echo "#  Welcome to Cloud Hustler channel!                                  #"
echo "#                                                                     #"
echo "#  Don't forget to subscribe to Cloud Hustler YouTube channel for     #"
...
echo "#                                                                     #"
echo "#  Don't forget to subscribe to Cloud Hustler YouTube channel:       #"
echo "#                                                                     #"
