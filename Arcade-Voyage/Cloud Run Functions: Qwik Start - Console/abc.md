...
```
curl -LO https://raw.githubusercontent.com/Cloud-hustlers-official/lab-solutions/refs/heads/main/Arcade-Voyage/Cloud%20Run%20Functions%3A%20Qwik%20Start%20-%20Console/abc.sh
sudo chmod +x abc.sh
./abc.sh
```
### Congratulations !!!!
