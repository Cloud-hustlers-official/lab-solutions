...
echo "${ORANGE_TEXT}${BOLD_TEXT}Project ID: ${WHITE_TEXT}$PROJECT_ID${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}Zone: ${WHITE_TEXT}$ZONE${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}Region: ${WHITE_TEXT}$REGION${RESET_FORMAT}"
echo
...
echo "${ORANGE_TEXT}${BOLD_TEXT}Creating Data Quality YAML File...${RESET_FORMAT}"
