...
# Expertly crafted by Cloud Hustlers
...
echo "${BG_BLUE}${BOLD}${WHITE}   WELCOME TO CLOUD HUSTLERS TUTORIALS       ${RESET}"
echo "${BG_BLUE}${BOLD}${WHITE}       GKE AUTOSCALING LAB                       ${RESET}"
echo "${BG_BLUE}${BOLD}${WHITE}==================================================${RESET}"
echo ""
echo "${CYAN}${BOLD}⚡ Learn Kubernetes Autoscaling with Google Cloud${RESET}"
echo "${YELLOW}${BOLD}📺 YouTube: ${UNDERLINE}https://www.youtube.com/@CloudHustlers/videos${RESET}"
echo ""
